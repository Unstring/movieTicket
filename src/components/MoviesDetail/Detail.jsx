...
export default function HorizontalCard() {
  return (
    ...
    >
      ...
      <Card
      >
        <h5 className="text-2xl flex justify-between font-bold tracking-tight text-gray-900 dark:text-white">
          <p>Movie Name </p>
          <p>16 sep 2023</p>
        </h5>
        <p className="font-normal text-gray-700 dark:text-gray-400">
            ...
            blanditiis nulla quibusdam sint libero hic quod consequuntur ab
            ipsa, optio iusto repellendus vitae esse nam rem? Et sit cum
